...
Make nnU-Net 3D Medical Image Segmentation the canonical identity across the shipped web app,
...
The web app and local API now ship under the nnU-Net 3D Medical Image Segmentation identity.
