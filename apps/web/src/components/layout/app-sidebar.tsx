...
import { LayoutDashboard, Boxes, Layers, FolderOpen, Settings, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navItems = [
  ...
  { title: "Segmentations", href: "/jobs", icon: Layers },
  { title: "Volumes", href: "/volumes", icon: Boxes },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-nnunet-3d-medical-image-segmentation"
          target="_blank"
